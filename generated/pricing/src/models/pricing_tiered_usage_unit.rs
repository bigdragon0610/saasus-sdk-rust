...
pub struct PricingTieredUsageUnit {
    /// Upper limit
...
impl PricingTieredUsageUnit {
    pub fn new(upper_count: i32, metering_unit_name: String, name: String, display_name: String, description: String, r#type: crate::models::UnitType, currency: crate::models::Currency, tiers: Vec<crate::models::PricingTier>, id: String, metering_unit_id: String, recurring_interval: crate::models::RecurringInterval, used: bool) -> PricingTieredUsageUnit {
