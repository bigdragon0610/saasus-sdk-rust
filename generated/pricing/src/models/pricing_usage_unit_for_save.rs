...
pub struct PricingUsageUnitForSave {
    /// Name
    #[serde(rename = "name")]
    pub name: String,
    /// Display Name
...
impl PricingUsageUnitForSave {
    pub fn new(name: String, display_name: String, description: String, r#type: crate::models::UnitType, currency: crate::models::Currency, upper_count: i32, unit_amount: i32, metering_unit_name: String) -> PricingUsageUnitForSave {
