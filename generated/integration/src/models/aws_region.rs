...
/// AwsRegion : 中国の寧夏、北京を除く全てのAWSリージョンが選択可能です。  All AWS regions except Ningxia and Beijing in China can be selected. 
...
impl ToString for AwsRegion {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::ApSoutheast3 => String::from("ap-southeast-3"),
